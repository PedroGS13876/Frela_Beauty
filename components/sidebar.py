    ...
    dbc.Modal([
        ...
        dbc.ModalBody([
            ...
            dbc.Row([
                ...
                dbc.ModalFooter([
                    dbc.Button("Adicionar despesa", color="error", id="salvar_despesa"),
...
def manage_category_despesa(n, n2, txt, check_delete, data):
...
def manage_category_receita(n, n2, txt, check_delete, data):
...
def save_form_despesa(n, valor, switches, categoria, date, txt, dict_despesas):
    ...
    if n and not(valor == "" or valor is None):
        ...
        df_despesas.loc[df_despesas.shape[0]] = [valor, recebido, fixo, date, txt, categoria]
